...
export default function AlunoApp() {
  ...
  // Foco e jogos (para aula ativa) -- o sensor em si fica escondido do
  // aluno: não existe um botão de "ativar sensor" de propósito, ver
  // handleEntrarAulaPorCodigo (o gate acontece silenciosamente lá).
